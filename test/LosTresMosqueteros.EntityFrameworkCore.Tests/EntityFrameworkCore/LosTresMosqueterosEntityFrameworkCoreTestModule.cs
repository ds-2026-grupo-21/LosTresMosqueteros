...
[DependsOn(
    typeof(LosTresMosqueterosApplicationTestModule),
    typeof(LosTresMosqueterosEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
)]
public class LosTresMosqueterosEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new LosTresMosqueterosDbContext(new DbContextOptionsBuilder<LosTresMosqueterosDbContext>().UseSqlite(_database.ConnectionString).Options));
