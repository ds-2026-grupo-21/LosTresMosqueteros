...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #N` y solicitar revisión a `@ds-2026-grupo-21/reviewers`.
...
`https://github.com/ds-2026-grupo-21/LosTresMosqueteros/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`