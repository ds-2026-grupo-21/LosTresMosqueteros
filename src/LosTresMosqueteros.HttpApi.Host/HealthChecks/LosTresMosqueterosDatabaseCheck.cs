...
public class LosTresMosqueterosDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public LosTresMosqueterosDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
