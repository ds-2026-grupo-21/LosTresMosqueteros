...
public class LosTresMosqueterosDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        LosTresMosqueterosGlobalFeatureConfigurator.Configure();
        LosTresMosqueterosModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<LosTresMosqueterosDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<LosTresMosqueterosResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/LosTresMosqueteros");

            options.DefaultResourceType = typeof(LosTresMosqueterosResource);
        ...
        {
            options.MapCodeNamespace("LosTresMosqueteros", typeof(LosTresMosqueterosResource));
        });
    }
}
